...
#
# Exit status: 0 compatible and buildable, 1 incompatible, 2 the command line is
# wrong, 3 compatible but this host is missing build dependencies.
set -eu
...
if output_format == "json":
    ...
    if report.missing_dependencies:
        print("missing host packages: " + ", ".join(report.missing_dependencies))
