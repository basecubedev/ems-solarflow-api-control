...
AUDITED_PLANS = {
    ...
    admin_lifecycle.TYPE_LIFECYCLE: "admin.lifecycle",
    ...
    ssh_service.TYPE_SSH_SERVICE: "ssh.service",
    ssh_service.TYPE_SSH_SHELL_ACCESS: "ssh.shell_access",
    ...
    support_archive.TYPE_SUPPORT_ARCHIVE: "support.archive",
