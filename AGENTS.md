...
This project is indexed by GitNexus as **ems-solarflow-api-control** (20452 symbols, 51991 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
