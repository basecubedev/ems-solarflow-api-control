    ...
    _section(
        ...
        [
            ...
            _field(
                ...
                "AC charging",
                "Lets EMS charge this device from surplus. Needs the AC charging feature on, and a model whose AC charge path is established.",
                "boolean",
                level="advanced",
                risk="control_stability",
            ),
            _field(
                ...
                "AC charge limit",
                "Highest AC charging power for this device. Leave at 0 to derive it from the device output limit.",
                "number",
                level="advanced",
                unit="W",
                minimum=0,
    ...
    _section(
        ...
        [
            ...
            _field(
                ...
                "Confirmation cycles",
                "Control loops the surplus must hold before charging starts. Leaving charge is always immediate.",
                "number",
                level="advanced",
                minimum=1,
                risk="control_stability",
            ...
            _field(
                ...
                "Total charge limit",
                "Highest combined AC charging power across all devices.",
                "number",
                unit="W",
                minimum=0,
                risk="control_stability",
            ...
            _field(
                "ac_charge_control.charge_ramp_up_w_per_cycle",
                "Ramp up",
                "Fastest charging power increase per control loop. Keep it above the device's own ramp so EMS does not slow the hardware down.",
                "number",
                level="advanced",
                unit="W",
                minimum=0,
            ...
            _field(
                "ac_charge_control.charge_ramp_down_w_per_cycle",
                "Ramp down",
                "Fastest charging power decrease per control loop.",
                "number",
                level="advanced",
                unit="W",
                minimum=0,
